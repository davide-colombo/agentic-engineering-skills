...
These instructions apply to this repository. Keep this file short, stable, and task-agnostic. Projects may import or mirror `AGENTS.md` when the active tool supports that convention; otherwise keep both files behaviorally equivalent.
